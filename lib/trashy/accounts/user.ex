defmodule Trashy.Accounts.User do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Trashy.Repo)
  ...
  """
  def valid_password?(%Trashy.Accounts.User{hashed_password: hashed_password}, password)
  ...
  def admin_properties_changeset(user, attrs) do
    ...
    |> cast_assoc(:cleanups, with: &Trashy.Cleanups.Cleanup.changeset/2)
    |> IO.inspect()
  end
end
